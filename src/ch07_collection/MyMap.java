...
import ch06_abstract_interface.cartest.Key;
import ch06_abstract_interface.enimaltest.Animal;
...
public class MyMap {
    public static void main(String[] args) {
        ...
        //'nc' 팀이 존재하는 지 체크하고, 없으면 순위 5위로 추가해 주세여.
        if (teamMap.containsKey(findItem) == false) {
            teamMap.put(findItem, 5);
        }

        //순위가 6위인 팀이 존재 하는지 체크하고, 존재하지 않으면 'kia'를 추가해 주세요.
        ...
        System.out.println("다음 팀들의 순위 정보를 출력해 주세요.");  //쇼핑물에서 써 먹을 일이 많음 꼭 알아야함
        String[] findTeams = {"두산", "kt", "빙그래"};
        ...
        System.out.println("전체 목록을 추력해 봅니다.");
